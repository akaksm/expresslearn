...
const sendForgetPasswordVerificationEmail = async (user) => {
  const options = {
    from: "no-reply@ecommerce.com",
    to: user.email,
    subject: "Forget Password Verification OTP",
    html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="otp-box">${user.forgetPassword.otp}</div>
...
module.exports = {sendEmailVerificationEmail,sendForgetPasswordVerificationEmail}